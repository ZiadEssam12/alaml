...
export type CouponUsageWhereInput = {
  ...
  usageId?: Prisma.IntFilter<"CouponUsage"> | number
  ...
  appliedAt?: Prisma.DateTimeFilter<"CouponUsage"> | Date | string
...
export type CouponUsageWhereUniqueInput = Prisma.AtLeast<{
  ...
  order?: Prisma.XOR<Prisma.OrderScalarRelationFilter, Prisma.OrderWhereInput>
  user?: Prisma.XOR<Prisma.UserScalarRelationFilter, Prisma.UserWhereInput>
}, "usageId" | "couponId_userId_orderId">
...
export type CouponUsageScalarWhereWithAggregatesInput = {
  ...
  usageId?: Prisma.IntWithAggregatesFilter<"CouponUsage"> | number
  ...
  appliedAt?: Prisma.DateTimeWithAggregatesFilter<"CouponUsage"> | Date | string
}
...
export type CouponUsageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"usageId" | "couponId" | "userId" | "orderId" | "appliedAt", ExtArgs["result"]["couponUsage"]>
...
export interface CouponUsageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const couponUsageWithUsageIdOnly = await prisma.couponUsage.findMany({ select: { usageId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many CouponUsages and only return the `usageId`
   * const couponUsageWithUsageIdOnly = await prisma.couponUsage.createManyAndReturn({
   *   select: { usageId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more CouponUsages and only return the `usageId`
   * const couponUsageWithUsageIdOnly = await prisma.couponUsage.updateManyAndReturn({
   *   select: { usageId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface CouponUsageFieldRefs {
  readonly usageId: Prisma.FieldRef<"CouponUsage", 'Int'>
  ...
  readonly appliedAt: Prisma.FieldRef<"CouponUsage", 'DateTime'>
}
