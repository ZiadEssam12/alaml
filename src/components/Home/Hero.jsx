...
export default function Hero() {
  return (
    <section className="relative w-screen my-0! -mt-10!  right-1/2 translate-x-1/2  bg-linear-to-br from-primary/10 via-secondary/5 to-accent/10 py-20 lg:py-32 overflow-hidden">
      {/* Background Pattern */}
          ...
          <div className="text-center lg:text-right space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg lg:text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0">
                نقدم لك أفضل المنتجات المكتبية بأسعار تنافسية وجودة عالية. من
